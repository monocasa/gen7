...
void DcMachineContext::LoadElf( const char *exePath, jitpp::Sh4aCpuContext &context )
{
...
void DcMachineContext::LoadBios( jitpp::Sh4aCpuContext &context )
{
...
void DcMachineContext::Load( const char *path )
{
	...
	jitpp::Sh4aCpuContext *context = new (perThreadContext) jitpp::Sh4aCpuContext();
